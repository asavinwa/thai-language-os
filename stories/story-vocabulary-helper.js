const storyWordDictionary = {
  'ผม':'I / me (male speaker)','ฉัน':'I / me','เขา':'he / she / they','เธอ':'she / you','เรา':'we / us','ทุกคน':'everyone','คน':'person / people','ตัวเอง':'oneself / myself / himself','แม่':'mum / mother','ป้า':'aunt / older female relative','เพื่อน':'friend','ครอบครัว':'family','ภรรยา':'wife','ทีม':'team','ลูกค้า':'customer / client',
  'วันนี้':'today','วัน':'day','วันหนึ่ง':'one day','เย็น':'evening','คืนนั้น':'that night','ตอน':'time / when','ตอนเช้า':'in the morning','ครั้ง':'time / occasion','ครั้งนี้':'this time','ครั้งแรก':'first time','หลายครั้ง':'many times','ปี':'year','นาที':'minute','ทุกวัน':'every day','ปกติ':'normally','บางครั้ง':'sometimes','สุดท้าย':'finally / in the end','ในที่สุด':'finally / in the end','ต่อมา':'later / next','หลังจากนั้น':'after that','เมื่อกี้':'just now',
...
function addMoreStoryWords() {
  ...
  // Add a few high-value multiword chunks that Thai segmentation may split.
